...
| ******************************************************************************	
	...
	.ascii "(C)PASCAL   2000"									                | Copyrght
	.ascii "NeoZeddo karāanimēshon                          "	| Domestic name
	.ascii "NEOZEED COLOR ANIMATION                         "	| International name
  ...
  .ascii "                                        "			    | Notes - 52 bytes
	.ascii "JUE             "									                | J=Japan, U=USA, E=Europe
...
SkipSetup:
	bra     Continue
Table:
  .word 0x008000, 0x003fff, 0x000100, 0x0000a0, 0x000000, 0x0000a1, 0x001100, 0x0000a1
  .word 0x001200, 0x0000c0, 0x000000, 0x0000c0, 0x000004, 0x000414, 0x00302c, 0x000754
  .word 0x000000, 0x000000, 0x000000, 0x00812b, 0x000001, 0x000100, 0x0000ff, 0x00ff00                                   
  .word 0x000080, 0x004000, 0x000080, 0x00af01, 0x00d91f, 0x001127, 0x000021, 0x002600
  .word 0x00f977, 0x00edb0, 0x00dde1, 0x00fde1, 0x00ed47, 0x00ed4f, 0x00d1e1, 0x00f108                                   
  .word 0x00d9c1, 0x00d1e1, 0x00f1f9, 0x00f3ed, 0x005636, 0x00e9e9, 0x008104, 0x008f01                
  .word 0x00c000, 0x000000, 0x004000, 0x000010, 0x009fbf, 0x00dfff                                
...
|----------------------------------------------------------        
Z80Driver:
  .byte  0x00c3,0x0046,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x0000
  .byte  0x0000,0x0000,0x0000,0x0000,0x0000,0x0000,0x00f3,0x00ed
  .byte  0x0056,0x0031,0x0000,0x0020,0x003a,0x0039,0x0000,0x00b7
  .byte  0x00ca,0x004c,0x0000,0x0021,0x003a,0x0000,0x0011,0x0040
  .byte  0x0000,0x0001,0x0006,0x0000,0x00ed,0x00b0,0x003e,0x0000
  .byte  0x0032,0x0039,0x0000,0x003e,0x00b4,0x0032,0x0002,0x0040
  .byte  0x003e,0x00c0,0x0032,0x0003,0x0040,0x003e,0x002b,0x0032
  .byte  0x0000,0x0040,0x003e,0x0080,0x0032,0x0001,0x0040,0x003a
  .byte  0x0043,0x0000,0x004f,0x003a,0x0044,0x0000,0x0047,0x003e
  .byte  0x0006,0x003d,0x00c2,0x0081,0x0000,0x0021,0x0000,0x0060
  .byte  0x003a,0x0041,0x0000,0x0007,0x0077,0x003a,0x0042,0x0000
  .byte  0x0077,0x000f,0x0077,0x000f,0x0077,0x000f,0x0077,0x000f
  .byte  0x0077,0x000f,0x0077,0x000f,0x0077,0x000f,0x0077,0x003a
  .byte  0x0040,0x0000,0x006f,0x003a,0x0041,0x0000,0x00f6,0x0080
  .byte  0x0067,0x003e,0x002a,0x0032,0x0000,0x0040,0x007e,0x0032
  .byte  0x0001,0x0040,0x0021,0x0040,0x0000,0x007e,0x00c6,0x0001
  .byte  0x0077,0x0023,0x007e,0x00ce,0x0000,0x0077,0x0023,0x007e
  .byte  0x00ce,0x0000,0x0077,0x003a,0x0039,0x0000,0x00b7,0x00c2
  .byte  0x004c,0x0000,0x000b,0x0078,0x00b1,0x00c2,0x007f,0x0000
  .byte  0x003a,0x0045,0x0000,0x00b7,0x00ca,0x004c,0x0000,0x003d
  .byte  0x003a,0x0045,0x0000,0x0006,0x00ff,0x000e,0x00ff,0x00c3
  .byte  0x007f,0x0000
